...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'cards.com'
  config.app_name = 'Cards'
  config.mailer.from = 'Cards <no-reply@cards.com>'
  ...
  #
  config.app_secret = '3sUwezXFP_3IsRCeTp65SpgM--ZbdwIrAdc45f5oSYsUzWS5o8DdwZbAQ7g40hnaFbc'
